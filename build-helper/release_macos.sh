...
repo="${CLIPFLOW_GITHUB_REPO:-kwd421/universal-mp4-browser-downloader}"
...
feed_url="${CLIPFLOW_SPARKLE_FEED_URL:-https://kwd421.github.io/universal-mp4-browser-downloader/appcast.xml}"
